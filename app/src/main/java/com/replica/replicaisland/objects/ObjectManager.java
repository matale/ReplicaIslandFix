 ...
 * ObjectManagers themselves are derived from BaseObject, so they may be
 * strung together into a hierarchy of objects.  ObjectManager may be
 * specialized to implement special types of traversals (e.g. PhasedObjectManager
 * sorts its children).
 */
