...
public class PhasedObjectManager extends ObjectManager {
    ...
    public void add(BaseObject object) {
        if (object instanceof PhasedObject) {
            ...
            // The only reason to restrict PhasedObjectManager to PhasedObjects is
            // so that the PhasedObjectComparator can assume all of its contents
            // are PhasedObjects and avoid calling instanceof every time.
