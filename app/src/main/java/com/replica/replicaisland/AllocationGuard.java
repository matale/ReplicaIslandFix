 ...
 * implements a "checkpoint" memory scheme.  After the static sGuardActive
 * flag has been set, any further allocation of AllocationGuard or its
 * derivatives will cause an error log entry.  Note that AllocationGuard
