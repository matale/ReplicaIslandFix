...
public class DiaryActivity extends Activity {
    ...
    private final OnClickListener mKillDiaryListener = new OnClickListener() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView text = findViewById(R.id.diarytext);

        ImageView image = findViewById(R.id.diarybackground);
