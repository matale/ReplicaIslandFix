...
import com.replica.replicaisland.misc.ScrollableBitmap;
import com.replica.replicaisland.misc.TObjectPool;
import com.replica.replicaisland.objects.ObjectPool;
import com.replica.replicaisland.tiled.TiledBackgroundVertexGrid;

/**
 * This class manages drawable objects that have short lifetimes (one or two
 * frames).  It provides type-specific allocator functions and a
 * type-insensitive release function.  This class manages pools of objects so
 * no actual allocations occur after bootstrap.
 */
public class DrawableFactory extends BaseObject {
    private final static int BITMAP_POOL_SIZE = 768;

    private final DrawableBitmapPool mBitmapPool;
    private final ScrollableBitmapPool mScrollableBitmapPool;
    private final TiledBackgroundVertexGridPool mTiledBackgroundVertexGridPool;
