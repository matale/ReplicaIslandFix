...
public class SoundSystem extends BaseObject {
    ...
    private final FixedSizeArray<Sound> mSounds;
    private final Sound mSearchDummy;
    private boolean mSoundEnabled;
    private final int[] mLoopingStreams;
    ...
    // sounds will continue to play.  Rather that reproduce all the
    // bookkeeping that SoundPool does internally here, I've opted to
    // just pause looping sounds when the Activity is paused.
