...
import com.replica.replicaisland.objects.ObjectRegistry;

/**
 * The core object from which most other objects are derived.  Anything that
 * will be managed by an ObjectManager, and anything that requires an update
 * per frame should be derived from BaseObject.  BaseObject also defines the
