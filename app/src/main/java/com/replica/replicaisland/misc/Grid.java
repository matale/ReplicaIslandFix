...
/**
 * A 2D rectangular mesh. Can be drawn textured or untextured. This
 * version is modified from the original Grid.java (found in the
 * SpriteText package in the APIDemos Android sample) to support hardware
...
public class Grid {
    ...
    private final Buffer mTexCoordBuffer;
    private final int mCoordinateSize;
    private final int mCoordinateType;
    private final int mVertsAcross;
    private final int mVertsDown;
