...
public class LevelBuilder extends BaseObject {
    ...
    public void addTileMapLayer(GameObject background, int priority, float scrollSpeed,
        ...
        //TODO: The map format should really just output independent speeds
        // for x and y, but as a short term solution we can assume parallax
        // layers lock in the smaller direction of movement.
