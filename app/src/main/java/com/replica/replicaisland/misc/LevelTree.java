...
public final class LevelTree {
    ...
    public static Level get(int row, int index) {
        return levels.get(row).levels.get(index);
    }

    public static boolean isLoaded(int resource) {
        return mLoaded && mLoadedResource == resource;
    }

    public static void loadLevelTree(int resource, Context context) {
    ...
    public static void updateCompletedState(int levelRow, int completedLevels) {
    ...
    public static int packCompletedLevels(int levelRow) {
        int completed = 0;
    ...
    public static boolean rowIsValid(int row) {
        boolean valid = row >= 0 && row < levels.size();
        return valid;
    }
