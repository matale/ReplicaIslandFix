 ...
 * the component-centric architecture of this engine.  The current code is
 * monolithic and should be refactored.
 */
public class HudSystem extends BaseObject {
    ...
    private final Vector2 mFlyButtonLocation;
    private final Vector2 mStompButtonLocation;
    private final Vector2 mMovementSliderBaseLocation;
    private final Vector2 mMovementSliderButtonLocation;
    private final Vector2 mCoinLocation;
    private final Vector2 mRubyLocation;
    private final int[] mCoinDigits;
    private final int[] mRubyDigits;
    private final Vector2 mFPSLocation;
    private final int[] mFPSDigits;
    private final DrawableBitmap[] mDigitDrawables;
