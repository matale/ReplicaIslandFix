...
import com.replica.replicaisland.misc.Lerp;
...
public class CameraSystem extends BaseObject {
    ...
    private static final int SHAKE_FREQUENCY = 40;
    private static final float BIAS_SPEED = 400.0f;
    private final Vector2 mCurrentCameraPosition;
    private final Vector2 mFocalPosition;
    private final Vector2 mPreInterpolateCameraPosition;
    private final Vector2 mTargetPosition;
    private final Vector2 mBias;
    ...
    public void update(float timeDelta, BaseObject parent) {
        ...
        if (mTarget != null) {
            ...
            if (mTargetChangedTime > 0.0f) {
                ...
                // Only respect the bias if the target is moving.  No camera motion
