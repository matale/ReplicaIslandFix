...
import com.replica.replicaisland.game_objects.GameRenderer;
...
import com.replica.replicaisland.objects.PhasedObject;
 ...
 * complete a frame the queues are swapped. Note that this class can
 * manage any number (>=2) of render queues, but increasing the number
 * over two means that the game logic will be running significantly ahead
 * of the rendering thread, which may make the user feel that the controls
 * are "loose."
 */
public class RenderSystem extends BaseObject {
    ...
    private final ObjectManager[] mRenderQueues;
