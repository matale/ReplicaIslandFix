...
public class ConversationDialogActivity extends Activity {
    ...
    private ArrayList<ConversationPage> mPages;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (levelRow != -1 && levelIndex != -1 && index != -1) {
            ...
            TypewriterTextView tv = findViewById(R.id.typewritertext);
    ...
    protected void showPage(ConversationPage page) {
        TypewriterTextView tv = findViewById(R.id.typewritertext);
        ...
        ImageView image = findViewById(R.id.speaker);
        ...
        TextView title = findViewById(R.id.speakername);
        if (page.title != null) {
    ...
    public static class TypewriterTextView extends androidx.appcompat.widget.AppCompatTextView {
        ...
        public long getRemainingTime() {
            return (long) (mText.length() - mCurrentCharacter) * TEXT_CHARACTER_DELAY_MS;
        }
