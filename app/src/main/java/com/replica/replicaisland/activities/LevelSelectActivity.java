...
public class LevelSelectActivity extends ListActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        boolean result = keyCode == KeyEvent.KEYCODE_BACK;
        return result;
    }
    ...
    private class DisableItemArrayAdapter<T> extends ArrayAdapter<T> {
        ...
        private final int mDisabledRowResource;
        private final int mCompletedRowResource;
        private final Context mContext;
        private final int mTextViewResource;
        private final int mTextViewResource2;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView view = sourceView.findViewById(mTextViewResource);
            if (view != null) {
                view.setText(mLevelData.get(position).level.name);
            }
            TextView view2 = sourceView.findViewById(mTextViewResource2);
            if (view2 != null) {
