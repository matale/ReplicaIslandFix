...
/**
 * CollisionParamaters defines global parameters related to
 * dynamic (object vs object) collisions.
 */
public final class CollisionParameters {
    // HitType describes the type of hit that a victim object receives.
    // Victims may choose to react differently to the intersection depending
    // on the hit type.
    // TODO: Make this a bit field so objects can support multiple hit types.
