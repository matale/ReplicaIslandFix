...
public class OrbitalMagnetComponent extends GameComponent {
    ...
    public void update(float timeDelta, BaseObject parent) {
        ...
        if (manager != null) {
            ...
            if (player != null) {
                ...
                applyMagnetism(player, parentObject.getCenteredPositionX(), parentObject.getCenteredPositionY(),
                        timeDelta);
            }
        }
    }
    ...
    private void applyMagnetism(GameObject target, float centerX, float centerY, float timeDelta) {
        ...
        if (distanceFromCenter2 < area2) {
            ...
            // mDelta is now the next point on the magnet circle in the direction
            // of movement.
