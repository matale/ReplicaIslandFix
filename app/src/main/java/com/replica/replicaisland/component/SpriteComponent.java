...
import com.replica.replicaisland.objects.PhasedObjectManager;

/**
 * Provides an interface for controlling a sprite with animations.  Manages
 * a list of animations and provides a drawable surface with the correct
 * animation frame to a render component each frame.  Also manages
 * horizontal and vertical flipping.
 */
public class SpriteComponent extends GameComponent {

    private final PhasedObjectManager mAnimations;
        ...
        if (animations.getCount() > 0 && currentAnimIndex != -1) {
            ...
            if (currentAnimation == null && currentAnimIndex != -1) {
                ...
                if (currentAnimation == null) {
                    ...
                    // Revert to our default animation.
            ...
            if (currentFrame != null) {
                ...
                if (render != null) {
                    ...
                    if (mVisible && currentFrame.texture != null && factory != null) {
                        // Fire and forget. Allocate a new bitmap for this animation frame,
                        // set it up, and pass it off to the render component for drawing.
