...
/**
 * A component that implements the "pop-out" AI behavior.
 * Pop-out characters alternate between hiding and appearing based on their
 * distance from the player.  They do not move or normally attack.
 */
