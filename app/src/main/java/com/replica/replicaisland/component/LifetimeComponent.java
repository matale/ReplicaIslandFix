...
/**
 * This component allows objects to die and be deleted when their life is
 * reduced to zero or they meet other configurable criteria.
 */
public class LifetimeComponent extends GameComponent {
    ...
    private void die(GameObject parentObject) {
        ...
        if (mReleaseGhostOnDeath) {
            // TODO: This is sort of a hack.  Find a better way to do this without introducing
            // a dependency between these two.  Generic on-death event or something.
