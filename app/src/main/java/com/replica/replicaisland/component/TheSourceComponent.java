...
public class TheSourceComponent extends GameComponent {
    ...
    private static final ChannelSystem.ChannelBooleanValue sChannelValue = new ChannelSystem.ChannelBooleanValue();
        ...
        if (mDead) {
            ...
            if (mExplosionTimer < 0.0f) {
                ...
                if (factory != null) {
                    ...
                    GameObject object = factory.spawn(GameObjectFactory.GameObjectType.EXPLOSION_GIANT,
