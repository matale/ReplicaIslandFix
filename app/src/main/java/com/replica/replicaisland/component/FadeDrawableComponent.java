...
public class FadeDrawableComponent extends GameComponent {
    ...
    public void update(float timeDelta, BaseObject parent) {
        if (mRenderComponent != null) {
            final TimeSystem time = BaseObject.sSystemRegistry.timeSystem;
            ...
            if (mInitialDelayTimer > 0.0f) {
                ...
                if (mTexture != null) {
                    ...
                    final DrawableFactory factory = BaseObject.sSystemRegistry.drawableFactory;
                    if (factory != null) {
    ...
    /**
     * Enables phases; initial delay will be re-started when phase ends.
     **/
