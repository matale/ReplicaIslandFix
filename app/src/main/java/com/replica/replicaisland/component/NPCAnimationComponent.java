...
import com.replica.replicaisland.systems.ChannelSystem.Channel;
...
public class NPCAnimationComponent extends GameComponent {
    ...
    // go back to idle when running into a wall
    ...
    protected boolean shouldTakeHit(GameObject parentObject) {
        boolean result = parentObject.getCurrentAction() == ActionType.HIT_REACT &&
