...
import com.replica.replicaisland.constants.AdultsDifficultyConstants;
import com.replica.replicaisland.constants.BabyDifficultyConstants;
import com.replica.replicaisland.constants.DifficultyConstants;
import com.replica.replicaisland.constants.KidsDifficultyConstants;
...
public class PlayerComponent extends GameComponent {
    ...
    private final Vector2 mHotSpotTestPoint;
            ...
            if (dpad.getPressed() || jumpButton.getPressed()) {
                ...
                if (jumpButton.getPressed()) {
                    if (jumpButton.getTriggered(time) && mTouchingGround) {
                        // In this case, velocity is instant so we don't
                        // need to scale it by time.
